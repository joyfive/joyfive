# 오기쁨 · Product Manager & Builder

복잡한 운영 정책과 업무 흐름을 제품 시스템으로 구조화하는 PM입니다.  
백오피스, 플랫폼 코어 시스템, 데이터 모델링, 외부 연동, 권한 구조에 관심이 많습니다.

AI 도구와 코드 에이전트를 활용해  
기획, 문서화, 프로토타이핑, 구현, 배포 흐름을 직접 설계합니다.

## Personal Projects
- [**오늘의 기쁨**](https://blog.joyfive.co.kr) — 노션 CMS로 사용하는 개인 블로그
- [**Kitfolio**](https://kitfolio.app) — 웹 도구 모음
- **주아모먼트** — 모바일 초대장 서비스
